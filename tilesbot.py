...
def mainFunc(timeDelay):  
    ...
    if sct_img.pixel(int(monitor["width"]/4),int(monitor["height"]/10))[0]<10:
            mouse.position = (int(monitor["width"]/8)  ,int(monitor["height"]/10)+monitor["top"]+offset)
            time.sleep(1)
            mouse.click(Button.left)    
    elif sct_img.pixel(int(monitor["width"]/4*3),int(monitor["height"]/10))[0]<10:
            mouse.position = (int(monitor["width"]/8*3),int(monitor["height"]/10)+monitor["top"]+offset)
            time.sleep(1)
            mouse.click(Button.left)
    elif sct_img.pixel(int(monitor["width"]/4*5),int(monitor["height"]/10))[0]<10:
            mouse.position = (int(monitor["width"]/8*5),int(monitor["height"]/10)+monitor["top"]+offset)
            time.sleep(1)
            mouse.click(Button.left)
    elif sct_img.pixel(int(monitor["width"]/4*7),int(monitor["height"]/10))[0]<10:
            mouse.position = (int(monitor["width"]/8*7),int(monitor["height"]/10)+monitor["top"]+offset)
            time.sleep(1)
            mouse.click(Button.left)     
